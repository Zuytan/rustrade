...
mod tests {
    ...
    fn create_context(
        ...
        AnalysisContext {
            ...
            slow_sma: None,
            trend_sma: None,
            rsi: Some(dec!(50.0)), // Used in some contexts? Breakout doesn't seem to use RSI but let's leave it or set to None if unused.
            macd_value: None,
            macd_signal: None,
            macd_histogram: None,
            last_macd_histogram: None,
            atr: Some(Decimal::ONE), // ATR often used for dynamic thresholds
            bb_lower: None,
            bb_middle: None,
            bb_upper: None,
            adx: Some(dec!(25.0)),
