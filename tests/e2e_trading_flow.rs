...
use rustrade::infrastructure::mock::{MockMarketDataService, MockExecutionService};
...
// sma_threshold: Decimal::from_f64(0.001).unwrap(), // Actual config uses f64? Checking file.
    ...
    let portfolio = std::sync::Arc::new(tokio::sync::RwLock::new(rustrade::domain::portfolio::Portfolio::new()));
